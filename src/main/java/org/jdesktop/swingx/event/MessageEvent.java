 ...
 * the user visible message text and an indication of when the message occured.
 * <p>
 * The message could represent text messages and exceptions. If this message
 * represents an exception then the value of {@link #getThrowable} will be non
 * null. Messages are categorized using the {@link java.util.logging.Level }
 * constants.
 * <p>
 */
public class MessageEvent extends EventObject {
	 ...
	 * @param value
	 *            an object which represents the contents of the event
	 * @param level
	 *            indicate the level of the event
	 * @param when
	...
	/**
	 * Returns the contents of the message. This level is based on the context
	 * of the message.
	 */
