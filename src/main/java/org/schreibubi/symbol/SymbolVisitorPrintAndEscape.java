 ...
 */
public class SymbolVisitorPrintAndEscape extends SymbolVisitor {
	PrintWriter	pw	= null;
	 ...
	 */
	public SymbolVisitorPrintAndEscape(PrintWriter pw) {
		this.pw = pw;
	}
	...
	public void visit(SymbolString s) {
		String str = s.getName() + "=\"" + s.getValueString().replace("\\", "\\\\").replace("\"", "\\\"") + "\"";
		this.pw.print(str);
	}
